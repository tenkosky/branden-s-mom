...
<pre>
user:~$ git clone https://github.com/b-stone/IMMERSE-2014.git
user:~$ cd IMMERSE-2014
</pre>
...
<pre>
user:~/IMMERSE-2014$ git clone https://github.com/mathjax/MathJax.git
</pre>

This creates a directory 'MathJax' in the 'IMMERSE-2014' folder. Depending on your OS, you might have to change the folder name to 'mathjax'. 
...
<pre>
user:~/IMMERSE-2014$ python -m SimpleHTTPServer 3000
</pre>
